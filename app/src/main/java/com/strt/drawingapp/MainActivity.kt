...
class MainActivity : AppCompatActivity() {
    ...
    val requestPermission:ActivityResultLauncher<Array<String>> =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()){
            ...
            if (isGranted){
                Toast.makeText(this@MainActivity,"Permission granted now you can access your gallery",Toast.LENGTH_SHORT).show()
                ...
                try {
                    ...
                    runOnUiThread{
                        ...
                        if (result.isNotEmpty())
                            Toast.makeText(this@MainActivity,"file save success",Toast.LENGTH_LONG).show()
                            shareImage(result)
                    }
                }
                catch (e:Exception){
